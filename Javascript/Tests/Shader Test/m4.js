define(function()
{
  ...
  rotation: function(m, angleVector){
    m = this.multiply(m, this.xRotation(angleVector[0]));
    m = this.multiply(m, this.yRotation(angleVector[1]));
    return this.multiply(m, this.zRotation(angleVector[2]));
  },
