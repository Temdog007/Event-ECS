require(['systemlist'], function(Systems)
{
  ...
  div.innerHTML = `<button type="button" id="updateButton">Update</button>
  ...
  <div id="debugContent">
    <table style="width:100%">
      <tr>
        <th>Level Depth</th>
        <th><input type="number" style="width:100%" placeholder="Enter level depth" id="levelDepth" value="1"/></th>
      </tr>
      <tr>
  ...
  document.getElementById('autoUpdateCheckbox').addEventListener("click", function(evt)
  {
  ...
  function getDepth()
  {
    var c = document.getElementById("levelDepth");
    return c.value;
  }
